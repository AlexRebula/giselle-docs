...
function SectionTitle({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
    import_Box10.default,
    {
      ...
      ...other,
      children: [
        caption && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SectionCaption, { title: caption, sx: slotProps?.caption?.sx }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_Typography.default, { component: "h2", variant: "h2", sx: slotProps?.title?.sx, children: [
          title,
          " ",
          txtGradient && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_Box10.default, { component: "span", sx: txtGradientSpanSx, children: txtGradient })
        ] }),
...
var MotionBox = (0, import_framer_motion9.motion)(import_Box11.default);
function FaqMotionViewport({ children, sx }) {
  const smDown = (0, import_useMediaQuery2.default)((theme) => theme.breakpoints.down("sm"));
  if (smDown) {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_Box11.default, { sx, children });
  }
...
var MotionSvg = (0, import_styles.styled)(import_framer_motion10.motion.svg, {
...
function FaqFloatLine({ sx, vertical, ...other }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    MotionSvg,
    {
      ...
      ...other,
      children: vertical ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        import_framer_motion10.motion.line,
        {
          x1: "0.5",
          x2: "0.5",
          y1: "0",
...
function FaqFloatPlusIcon({ sx, ...other }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    MotionSvg,
    {
      ...
      ...other,
      children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M8 0V16M16 8.08889H0" })
    }
  );
}
function FaqFloatTriangleDownIcon({ sx, ...other }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    MotionSvg,
    {
      ...
      ...other,
      children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M10 10L0 0H20L10 10Z" })
    }
  );
}
...
function FaqTopLines() {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_Stack.default, { spacing: 8, alignItems: "center", sx: topTriangleStackSx, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FaqFloatTriangleDownIcon, { sx: { position: "static", opacity: 0.12 } }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FaqFloatTriangleDownIcon, { sx: smallTriangleSx })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FaqFloatLine, { vertical: true, sx: { top: 0, left: FAQ_FLOAT_LINE_LEFT } })
  ] });
}
...
function FaqBottomLines() {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FaqFloatLine, { sx: { top: 0, left: 0 } }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FaqFloatLine, { sx: { bottom: 0, left: 0 } }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FaqFloatPlusIcon, { sx: { top: -8, left: FAQ_PLUS_ICON_LEFT } }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FaqFloatPlusIcon, { sx: { bottom: -8, left: FAQ_PLUS_ICON_LEFT } })
  ] });
}

// src/components/faq/accordion/faq-accordion.tsx
var import_jsx_runtime15 = require("react/jsx-runtime");
var MotionAccordion = (0, import_framer_motion11.motion)(import_Accordion.default);
function FaqSection({
  caption = "FAQs",
  ...
  const [expanded, setExpanded] = (0, import_react5.useState)(faqs[0]?.question ?? false);
  const handleChange = (panel) => (_event, isExpanded) => {
    setExpanded(isExpanded ? panel : false);
  };
  const resolvedIcon = typeof contactIcon === "string" ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(GiselleIcon, { icon: contactIcon }) : contactIcon;
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_Box12.default, { component: "section", sx: [...Array.isArray(sx) ? sx : [sx]], ...other, children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(FaqMotionViewport, { sx: { pt: 10, position: "relative" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(FaqTopLines, {}),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_Container.default, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_Box12.default, { sx: contentBoxSx, children: faqs.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
        MotionAccordion,
        {
          disableGutters: true,
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
              import_AccordionSummary.default,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_Typography2.default, { component: "span", variant: "h6", children: item.question })
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_AccordionDetails.default, { children: item.answer })
          ]
        },
        item.question
      )) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_Stack2.default, { sx: { position: "relative" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(FaqBottomLines, {}),
      contactHref && /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_Box12.default, { sx: contactSectionSx, children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_framer_motion11.motion.div, { variants: fade("in"), children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_Typography2.default, { variant: "h4", children: contactTitle }) }),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_framer_motion11.motion.div, { variants: fade("in"), children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_Typography2.default, { sx: { mt: 2, mb: 3, color: "text.secondary" }, children: contactDescription }) }),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_framer_motion11.motion.div, { variants: fade("in"), children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
